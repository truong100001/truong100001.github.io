...
if(biicore.bgMusic){
  ...
  document.write(`
	...
	<div class="bii-player">
		<div onclick="playPause();" class="bii-player-secondary"><div class="bii-player-secondary-content">Click vào đây để nghe bài hát của cô dâu và chú rể nhé</div></div>
...
if(!biicore.isPremium && !biicore.templatePremium) {
  ...
  document.write(`
	...
	<div class="bii-logo"><div class="bii-logo-secondary"><div class="bii-logo-secondary-content">Ná»n táº£ng táº¡o Website Ä‘Ă¡m cÆ°á»›i miá»…n phĂ­!</div></div><a href="${biicore.coreSite}/iwedding" target="_blank"><img src="${biiLogo}" /></a></div>
	<div class="bii-footer" style="z-index:9999;background-color: #000;border-top: 1px solid #df4759;color: #fff;text-align: center;letter-spacing: 1px;bottom: 0;width: 100%;font-size: 15px;">
		<div class="container">
			<a style="color: #fff;padding: 10px 0 13px;display: flex;align-items: center;justify-content: center;" href="https://biihappy.com/iwedding" target="_blank">
				<span style="margin-right: 5px;"><img width="30" src="${biiLogo}" style="border: 1px solid #fff;border-radius: 50%;width:30px!important;margin-right:5px;" /> IWedding</span> | <span class="show-desktop" style="margin-left: 5px;">Ná»n táº£ng táº¡o website Ä‘Ă¡m cÆ°á»›i miá»…n phĂ­ tá»« Biihappy</span><span class="show-mobile">Táº¡o website Ä‘Ă¡m cÆ°á»›i miá»…n phĂ­</span>
